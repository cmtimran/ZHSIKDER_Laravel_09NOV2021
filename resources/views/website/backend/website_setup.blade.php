        ...
        <div class="widget-content nopadding">
         ...
         <div class="control-group">
           <div class="controls">
            ...
            <div class="control-group">
              {{Form::label('About Us',null,['class'=>'control-label ckeditor'])}}

              <div class="controls">
                {{Form::textarea('about_us',$website_setup->about_us,['class'=>'span11 ckeditor'])}}
               </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                {{Form::textarea('history',$website_setup->history,['class'=>'span11 ckeditor'])}}
               </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                {{Form::textarea('overview',$website_setup->overview,['class'=>'span11 ckeditor'])}}
               </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                {{Form::textarea('mission_vision',$website_setup->mission_vision,['class'=>'span11 description ckeditor'])}}
               </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                {{Form::textarea('vision',$website_setup->vision,['class'=>'span11 description ckeditor'])}}
               </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                {{Form::textarea('strategy',$website_setup->strategy,['class'=>'span11 description ckeditor'])}}
               </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                {{Form::textarea('principle_message',$website_setup->principle_message,['class'=>'span11 description ckeditor'])}}
               </div>
            </div>
            <div class="control-group">
              {{Form::label('Founder Message',null,['class'=>'control-label'])}}
              <div class="controls">
                {{Form::textarea('founder_message',$website_setup->founder_message,['class'=>'span11 description ckeditor'])}}
               </div>
            </div>
            <div class="control-group">
              {{Form::label('Chairman Message',null,['class'=>'control-label'])}}
              <div class="controls">
                {{Form::textarea('chairman_message',$website_setup->chairman_message,['class'=>'span11 description ckeditor'])}}
               </div>
            </div>

            <div class="control-group">
              {{Form::label('ckeditor Message',null,['class'=>'control-label'])}}
              <div class="controls">
                {{Form::textarea('chairman_message',$website_setup->chairman_message,['class'=>'span11 description ckeditor'])}}
