...
class schollershipController extends Controller
{
    ...
    {
//        dd("he");
        $data['student_advisor'] = schollership_model::join('manage_department','schollership.department_id','=','manage_department.id')->get();
        $data['department'] = manage_department_model::groupby('department_name')->get();
        return view('website.backend.schollership_add',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $model_obj=new schollership_model;
        ...
        {
            $Data=$request->all();
            $notice_board_model_obj=new schollership_model;
