                            ...
                            <tr class="gradeX sort_teacher_each" data_teacher_id="{{$teacher_reports->teacher_id}}">
                                ...
                                <td class="center">
                                    ...
                                    <div class="display_status">
                                        @permission('EDIT')
                                        {{Form::open(['url'=>"teacher_info/$teacher_reports->teacher_id/edit" ,'method'=>'GET'])}} {{Form::submit('Edit',['class'=>'btn btn-primary'])}} {{Form::close()}}
                                        @endpermission

                                        @permission('DELETE')
                                        {{Form::open(['url'=>"teacher_info/$teacher_reports->teacher_id" ,'method'=>'DELETE'])}} {{Form::submit('Delete',['class'=>'btn btn-danger','onclick'=>"return confirm('Are you sure you want to Remove ?')"])}} {{Form::close()}}
                                        @endpermission
                                    </div>
                                </td>
                            </tr>
