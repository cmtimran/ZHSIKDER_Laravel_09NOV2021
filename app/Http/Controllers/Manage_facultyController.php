...
class Manage_facultyController extends Controller
{
    ...
    public function index()
    {
        ...
        $faculty = manage_faculty_model::join('teacher','manage_faculty.chairperson','=','teacher.teacher_id')->get();
    ...
    public function edit($id)
    {
        ...
        $faculty_info= manage_faculty_model::join('teacher','manage_faculty.chairperson','=','teacher.teacher_id')->where('faculty_id',$id)->first();
