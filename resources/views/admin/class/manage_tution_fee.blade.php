...
@section('content')
    ...
    <div class="container">
        ...
        <p title="Transport Details">{{Session::get('school.system_name')}}( {{Session::get('school.school_eiin')}} ) Tution Fees Details</p><br/><!-- Transport Details -->
        ...
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#home"><i class="fa fa-bars" aria-hidden="true"></i> Tution Fees</a></li>
            @permission('INSERT')
            <li><a data-toggle="tab" href="#menu1"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New Tution Fees</a></li>
            @endpermission
        </ul>
                            ...
                            @foreach($tution_fees as $tution_fees_list)
                                <tr class="gradeX">
                                    ...
                                    <td id="my_align" class="display_status">
                                        ...
                                        @permission('DELETE')
                                        {{Form::button('Delete',['class'=>'btn btn-danger class_delete','value'=>$tution_fees_list->tution_fees_id])}}
                                        @endpermission
