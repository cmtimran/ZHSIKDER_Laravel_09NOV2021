...
class activitisController extends Controller
{
    ...
    {
//        dd("he");
        $data['student_advisor'] = activities_model::join('manage_department','activities.department_id','=','manage_department.id')->get();
        $data['department'] = manage_department_model::groupby('department_name')->get();
        return view('website.backend.activities_add',$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $model_obj=new activities_model;
        ...
        {
            $Data=$request->all();
            $notice_board_model_obj=new activities_model;
