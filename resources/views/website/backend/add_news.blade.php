...
@section('content')
    ...
    <div class="container">
        ...
        <div class="tab-content">
            ...
            <div class="modal fade" id="myModal" role="dialog" style="width: 54% !important;">
                        ...
                        <div class="modal-body">
                            <div class="widget-content padding">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        {{Form::textarea('description','',['id'=>'required','placeholder'=>'Designation','title'=>'Designation','class'=>'ckeditor'])}}
                                    </div>
                                </div>

                                <div class="control-group">
                                    {{Form::label('news_date','News Date',['class'=>'control-label','title'=>'description'])}}
                                    <div class="controls">
                                        {{Form::date('news_date','',['id'=>'required','placeholder'=>'Designation','title'=>'Designation'])}}
                                    </div>
                                </div>
                        ...
                        @foreach($events as $key => $value)
                            <tr class="gradeX">
                                ...
                                <td id="my_align" class="display_status">
                                    ...
                                    {{Form::open(['url'=>"/frontend/news/$value->website_news_id/edit" ,'method'=>'GET'])}}
                                    {{Form::submit('Edit',['class'=>'btn btn-primary'])}}
                                    {{Form::close()}}

                                    {{Form::open(['url'=>"/frontend/news/$value->website_news_id" ,'method'=>'DELETE'])}}
