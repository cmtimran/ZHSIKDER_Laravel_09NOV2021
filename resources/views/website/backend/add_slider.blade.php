...
<div class='row'>
   ...
   <div class="tab-content">
      ...
      <div class="modal fade" id="myModal" role="dialog" style="width:50% !important;left:46% !important;">
                    ...
                    {{Form::open(['url'=>'/frontend/slider','class'=>'form-horizontal','method'=>'post','files'=>true,'name'=>'basic_validate','id'=>'basic_validate','novalidate'=>'novalidate'])}}
                        ...
                        <div class="control-group">
                          {{Form::label('title','Title',['class'=>'control-label','title'=>'title'])}}
                            <div class="controls">
                            {{Form::text('title','',['id'=>'required','placeholder'=>'Title','title'=>'title','style'=>'width: 96% !important;'])}}
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                          {{Form::label('description','Description',['class'=>'control-label','title'=>'Description'])}}
                            <div class="controls">
                            {{Form::textarea('description','',['id'=>'required','placeholder'=>'Description','title'=>'description','style'=>'width: 96% !important;'])}}
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                          {{Form::label('optional_text','Optional Text',['class'=>'control-label','title'=>'optional_text'])}}
                            <div class="controls">
                            {{Form::text('optional_text','',['id'=>'required','placeholder'=>'Optional Text','title'=>'optional_text','style'=>'width: 96% !important;'])}}
                            </div>
                        </div>
                        ...
                        <div class="controls"> 
                        {{Form::image('img/blankavatar.png','Profile_image',['alt'=>'Your Image','class'=>'img-responsive img-circle blank_applicant_student_image','id'=>'blah','style'=>'width:19%','style'=>'width: 30% !important;'])}}
                        <br>
